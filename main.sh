...
GUACAMOLE_DOWNLOAD_LINK="http://mirrors.noc.one/apache/guacamole/apache/guacamole/1.3.0/source/guacamole-server-1.3.0.tar.gz"
...
echo "---------------------------------------------------------------------------------------------------------------------"
echo "Made by SukkaW in 2021/01/23"
echo "---------------------------------------------------------------------------------------------------------------------"
...
echo "Input Your Guacomleb Username: "
read guacamole_username
echo "Input Your Guacomleb Password: "
...
apt-get install libjpeg62-turbo-dev language-pack-ja language-pack-zh* language-pack-ko -y
...
if [ $? = 0 ] ; then
  echo "---------------------------------------------------------------------------------------------------------------------"
  echo -e "\033[32m Guacomleb RDP is installed  is [OK] \033[0m"
  echo "---------------------------------------------------------------------------------------------------------------------"
  echo -e "\n\n\n"
else
  echo "---------------------------------------------------------------------------------------------------------------------"
  echo -e "Guacomleb RDP is installation failed!!!!!! See the log above."
  echo "---------------------------------------------------------------------------------------------------------------------"
  echo -e "\n\n\n"
fi
